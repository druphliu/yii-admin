...
;layui.define("view", function (e) {
    var a = layui.jquery, i = layui.laytpl, t = layui.element, n = layui.setter, l = layui.view, s = layui.device(),
        ...
        y = "layui-disabled", m = "#LAY_app_body", h = "LAY_app_flexible", f = "layadmin-side-spread-sm",
        p = "layadmin-tabsbody-item", v = "layui-icon-shrink-right", b = "layui-icon-spread-left",
        g = "layadmin-side-shrink", C = "LAY-system-side-menu", x = {
            v: "1.0.0 pro", req: l.req, sendAuthCode: function (e) {
                ...
                var i = u, t = a("#" + h), l = x.screen();
                "spread" === e ? (t.removeClass(b).addClass(v), l < 2 ? i.addClass(f) : i.removeClass(f), i.removeClass(g)) : (t.removeClass(v).addClass(b), l < 2 ? i.removeClass(g) : i.addClass(g), i.removeClass(f)), layui.event.call(this, n.MOD_NAME, "side({*})", {status: e})
            }, escape: function (e) {
                ...
                var a = n.theme;
                e = e || 0, a.color[e] && (a.color[e].index = e, x.theme({color: a.color[e]}))
            ...
            flexible: function (e) {
                ...
                var a = e.data("index");
                e.siblings(".layui-this").data("index"), e.hasClass(d) || (e.addClass(d).siblings(".layui-this").removeClass(d), x.initTheme(a))
    ...
    !function () {
        ...
        }, n = a("#" + C), l = "layui-nav-itemed", s = function (e) {
            var n = x.correctRouter(i.join("/"));
            e.each(function (e, s) {
                var r = a(s), o = t(r), u = o.list.children("dd"),
                    c = i[0] == o.name || 0 === e && !i[0] || o.jump && n == x.correctRouter(o.jump);
                if (u.each(function (e, s) {
                    var r = a(s), u = t(r), c = u.list.children("dd"),
    ...
    o.on("click", z, function () {
        ...
        layui.router(), x.tabsPage.elem = e, location.hash = x.correctRouter(i)
