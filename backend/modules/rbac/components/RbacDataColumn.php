 ...
 * @since 2.0
 */
class RbacDataColumn extends Column
{
    /**
    ...
    public $filterOptions = ['class'=>'search-item full-left'];
    ...
    protected function renderFilterCellContent()
    {
        ...
        if ($this->filter !== false && $model instanceof Model && $this->attribute !== null && $model->isAttributeActive($this->attribute)) {
            ...
            $name = $model->getAttributeLabel($this->attribute);
            if (is_array($this->filter)) {
                $options = array_merge(['prompt' => ''], $this->filterInputOptions);
                return Html::activeDropDownList($model, $this->attribute, $this->filter, $options) . $error;
            } else {
                $options = array_merge(['placeholder' => $name], $this->filterInputOptions);
    ...
    {
        if($this->renderFilterCellContent()!="&nbsp;") {
